...
Magnets need to move into the 21st century. The NdFeB incumbent, which dominates over 60% of a $30B magnet market, was discovered in the 80s, and the field has not replaced it since.
...
The property side of the problem is data-limited. Magnetocrystalline anisotropy, the property that makes a permanent magnet hard, is absent from every large public database. We built and calibrated a screening dataset of 2,242 computed anisotropy labels for rare-earth-free uniaxial crystals, with relaxed structures and a quantified per-label error model:

→ [**A Calibrated Screening Dataset of Magnetocrystalline Anisotropy for Rare-Earth-Free Magnet Discovery**](/project-014/magnet-anisotropy-dataset/)
